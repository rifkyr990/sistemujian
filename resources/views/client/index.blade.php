                        ...
                        <div class="card border-primary bg-transparent">
                            <div class="card-body">
                                ...
                                <p class="mb-0 float-start">
                                    <a href="" class="text-decoration-none text-dark open-modal"
                                        style="pointer-events: none">{{ $data->name }}</a>
                                </p>
                                <p class="float-end mb-0">{{ $result->score }} / 100</p>
                                @else
                                <p class="mb-0 float-start">
                                    <a href="{{route('admin.categories.show', $data->id)}}" class="text-decoration-none text-dark open-modal">{{ $data->name }}</a>
                                </p>
